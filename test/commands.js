  ...
  describe('parseArgs', function () {
    describe('get', function () {
      ...
      it('should accept arguemnts', function () {
        assert.deepInclude(get('get foo from bar'), {
          arguments: { from: 'bar' }
        });
      });

      it('should accept argument keywords', function () {
        assert.deepInclude(get('get foo from all bar'), {
          argumentKeywords: { from: { all: true } }
        });
      });
      ...
      it('should return all arguments', function () {
        ...
        assert.include(get('get all foo from bar'), {
          wholeArgument: 'all foo from bar'
        });
        assert.include(get('get all foo from all bar'), {
          wholeArgument: 'all foo from all bar'
        });
      });
